...
def generate_er():
    with app.app_context():
        ...
        try:
            ...
            print("Make sure graphviz is installed on the system (apt install graphviz)")
...
if __name__ == "__main__":
    try:
        ...
        print("Please install sqlalchemy_schemadisplay: pip install sqlalchemy_schemadisplay pydot")
