...
const AdminDashboard = {
    template: `
        <div class="container">
            ...
            <ul class="nav nav-tabs mb-3">
                ...
                <li class="nav-item"><a class="nav-link" :class="{active: tab === 'doctors'}" @click="tab='doctors'" href="#">Manage Doctors</a></li>
            ...
            <div v-if="tab === 'doctors'">
                <button class="btn btn-secondary mb-3" @click="showAddDoctor = !showAddDoctor">Add New Doctor</button>
    ...
    setup() {
        ...
        async function loadData() {
            ...
            appointments.value = await apiCall('/my-appointments'); // Using my-appointments endpoint which handles admin too
        }
        ...
        onMounted(loadData);
        return { tab, stats, doctors, departments, appointments, showAddDoctor, newDoctor, addDoctor, deleteDoctor };
    }
};
...
const PatientDashboard = {
    ...
    setup() {
        ...
        onMounted(loadInit);
        return { tab, departments, doctors, appointments, selectedDept, bookingDoc, bookForm, loadDoctors, promptBook, confirmBook, cancelAppt };
    }
};
