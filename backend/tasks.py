...
This module contains all the background tasks for the Hospital Operations System:
...
def build_monthly_report_html(doctor, appointments, month_name):
    ...
    html += """
        ...
        <p><em>This report was automatically generated by the Hospital Operations System.</em></p>
    </body>
    </html>
    """
